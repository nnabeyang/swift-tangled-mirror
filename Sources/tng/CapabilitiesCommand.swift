...
enum CapabilityCatalog {
  ...
  private static let metadata: [String: Metadata] = [
    ...
    "repo collaborator list": Metadata(access: .read, authenticationRequired: false),
    "repo collaborator add": Metadata(access: .write, authenticationRequired: true),
    "repo collaborator remove": Metadata(access: .write, authenticationRequired: true),
    "repo secret list": Metadata(access: .read, authenticationRequired: true),
    "repo secret add": Metadata(access: .write, authenticationRequired: true),
    "repo secret remove": Metadata(access: .write, authenticationRequired: true),
    ...
    "pipeline logs": Metadata(access: .read, authenticationRequired: false),
