...
The `tng` release binary statically links the SwiftPM dependency closure
resolved by `Package.resolved`. It also contains source generated from the
locked AT Protocol and Tangled lexicons. The corresponding license texts and
notices are included in `LICENSES/`.

| Component | Locked version or revision | License |
| --- | --- | --- |
...
| [swift-displaywidth](https://github.com/ainame/swift-displaywidth) | 0.1.0 / `5493276f6c91fd09d348e6cea70d66346fc7b610` | MIT |
| [swift-websocket](https://github.com/hummingbird-project/swift-websocket) | 1.6.1 / `126df9655565068bd97838c072c1db11f9fd42ee` | Apache-2.0 |
| [SwiftNIO](https://github.com/apple/swift-nio) | 2.101.3 / `0b18836bd8b0162e7e17a995a3fbee20ed8f3b2b` | Apache-2.0 |
| [swift-nio-extras](https://github.com/apple/swift-nio-extras) | 1.34.3 / `88a51340f59cf181ebde888bd1b749296b3ec029` | Apache-2.0 |
| [swift-nio-http2](https://github.com/apple/swift-nio-http2) | 1.45.0 / `45bdf670248be5f16ec0340e125dca285536f0fb` | Apache-2.0 |
| [swift-nio-ssl](https://github.com/apple/swift-nio-ssl) | 2.37.2 / `d930168b86f46ca51a4bc09c5ca45c1833db8067` | Apache-2.0 |
...
| [compress-nio](https://github.com/adam-fowler/compress-nio) | 1.4.2 / `e1caa19077dda4b00441142ef57da3db02acd466` | Apache-2.0 |
| [swift-service-lifecycle](https://github.com/swift-server/swift-service-lifecycle) | 2.11.0 / `9829955b385e5bb88128b73f1b8389e9b9c3191a` | Apache-2.0 |
| [swift-http-types](https://github.com/apple/swift-http-types) | 1.6.0 / `db774a277f60063a32d854f2980299caf06da041` | Apache-2.0 |
| [swift-http-structured-headers](https://github.com/apple/swift-http-structured-headers) | 1.7.0 / `933538faa42c432d385f02e07df0ace7c5ecfc47` | Apache-2.0 |
| [swift-certificates](https://github.com/apple/swift-certificates) | 1.19.3 / `89fbc3714264cce8db8e4ec51b64e01c3e28c6c5` | Apache-2.0 |
| [swift-async-algorithms](https://github.com/apple/swift-async-algorithms) | 1.1.5 / `3da39bbc4e687d4192af7c9cf4eab805745a0b9c` | Apache-2.0 |
| [swift-algorithms](https://github.com/apple/swift-algorithms) | 1.2.1 / `87e50f483c54e6efd60e885f7f5aa946cee68023` | Apache-2.0 |
| [swift-numerics](https://github.com/apple/swift-numerics) | 1.1.1 / `0c0290ff6b24942dadb83a929ffaaa1481df04a2` | Apache-2.0 |
| [swift-syntax](https://github.com/swiftlang/swift-syntax) | 603.0.2 / `79e4b74a295b6eb74a8b585e3a39d29e70c1dbd1` | Apache-2.0 |

The dependency list is based on the release build's locked package graph. No
endorsement by the original projects is implied.
